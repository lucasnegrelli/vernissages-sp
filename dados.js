...
{name:"Fortes D'Aloia & Gabriel — Galeria",ig:"fortesdaloiagabriel",site:"https://fdag.com.br",addr:"R. Barão de Capanema, 343",b:"Cerqueira César",z:"Oeste",tipo:"galeria",lat:-23.5601,lng:-46.6641,info:"Espaço FDAG Jardins (endereço atualizado pelo site da galeria). Ernesto Neto, Rivane Neuenschwander, Erika Verzutti. Espaço-irmão: Galpão (Barra Funda)."},
...
{name:"Casa do Povo",site:"https://casadopovo.org.br",addr:"R. Três Rios, 252",b:"Bom Retiro",z:"Centro",tipo:"institucional",lat:-23.5281,lng:-46.6392,ing:{g:true},info:"Centro cultural experimental no Bom Retiro."},
...
{name:"Massapê Projetos",ig:"massape_projetos",addr:"R. Fortunato, 68",b:"Santa Cecília",z:"Centro",tipo:"hibrido",lat:-23.5395,lng:-46.6495,ing:{g:true},info:"Plataforma de arte contemporânea gerida por artistas; galeria e ateliê compartilhado com Mano Penalva, Marcelo Pacheco, Marina Rodrigues, Fabiana Preti e Tchelo."},
{name:"Espaço República",ig:"espacorepublica",addr:"Av. São Luís, 86",b:"República",z:"Centro",tipo:"hibrido",lat:-23.5448,lng:-46.6405,ing:{g:true},info:"Núcleo cultural aberto em 2025 no centro histórico: cinco andares com ateliês privativos e coletivos, cursos, residência e andar expositivo. Sala expositiva Vera Helena."},
{name:"Ateliê397",ig:"atelie397",site:"https://atelie397.com",addr:"Travessa Dona Paula, 126",b:"Higienópolis",z:"Centro",tipo:"hibrido",lat:-23.5432,lng:-46.6558,ing:{g:true},info:"Desde 2003, um dos espaços independentes mais longevos da cidade: ateliê, residências e exposições de arte contemporânea. Mantém o grupo de acompanhamento Clínica Geral."},
...
{name:"Projeto Caroço",site:"https://www.carocoprojeto.com",addr:"Lapa (endereço a confirmar)",b:"Lapa",z:"Oeste",tipo:"hibrido",lat:-23.5225,lng:-46.7020,info:"Espaço independente em galpão de mais de 200 m², com duas salas expositivas e pátio; financia projetos de artistas independentes."}
];
...
{t:"Mitologias do Mistério — Gabriel Omep",a:"Gabriel Omep",v:"Casa de Cultura do Parque",ini:"2026-07-25",fim:"2026-10-25",d:"Individual dentro do II Ciclo Expositivo; curadoria de Claudio Cretti e texto crítico de André Pitol. Quatro séries — Alfabeto Ferramenta, Orís, Guardiões e Indumentária — em pintura sobre papelão e peças em MDF."},
...
{t:"Arte da Nossa Gente — coletiva",v:"MAB FAAP",ini:"2026-06-10",fim:"2026-10-12",d:"Mais de 150 obras que celebram a pluralidade cultural brasileira, com acervo da Galeria Estação (Antônio Poteiro entre os artistas). Terça a domingo, 10h–18h."},
...
{t:"Fascination and Affection — coletiva",v:"Galeria Nara Roesler",ini:"2026-05-26",fim:"2026-08-08",d:"Recorte do programa da galeria; curadoria de Agnaldo Farias."},
...
{t:"Peças Frias — O Desenho — Iran do Espírito Santo",a:"Iran do Espírito Santo",v:"Fortes D'Aloia & Gabriel — Galeria",ini:"2026-06-30",fim:"2026-08-08",d:"Individual do artista no espaço FDAG Jardins. Ter–sex 10h–19h, sáb 10h–18h."},
...
{t:"Sem palavras — Vânia Mignone",a:"Vânia Mignone",v:"Casa Triângulo",ini:"2026-08-08",fim:null,d:"Abertura sábado 08/08, 11h–15h. Individual que celebra 30 anos de parceria entre a artista e a galeria. Data de encerramento a confirmar."},
...
{t:"Acontecimentos de Corpos — Novas Poéticas",v:"Massapê Projetos",ini:"2026-08-01",fim:null,d:"Coletiva do programa Novas Poéticas com 12 artistas de diferentes regiões do Brasil, dando continuidade ao percurso iniciado em Buenos Aires. Curadoria de Thais Bambozzi e Omar Porto; abertura 01/08 com DJ set. Data de encerramento a confirmar."},
{t:"A noite não adormece nos olhos das mulheres — coletiva",a:"Amanda Fahur, Bárbara Banida, Céu Isatto, Gi Monteiro, Gio Soifer, Luiza Lukah, Madu Peruzzo, Natha Calhova, Nazas, Nina Horikawa, Tais Koshino, Thiá Sguoti",v:"Projeto Caroço",ini:"2026-07-21",fim:"2026-08-15",d:"Coletiva de doze artistas com curadoria do Mulheres Arquivadas; o título remete ao poema de Conceição Evaristo dedicado a Beatriz Nascimento."}
];
...
{t:"Clínica Geral — grupo de acompanhamento de projetos do Ateliê397",org:"Ateliê397",cat:"chamada",prazo:null,quem:"Artistas, curadores e pesquisadores em arte contemporânea",onde:"São Paulo (turmas online e presencial)",taxa:"a confirmar",d:"Grupo de acompanhamento de projetos que completa dez anos, com mediação de Érica Burini, Kauê Garcia, Lucas Goulart e Thaís Rivitti. Turma online às segundas (19h–22h) e presencial às quartas (19h–22h). Inscrições nos últimos dias em 30/07/2026; data-limite exata não divulgada no anúncio.",link:"https://atelie397.com",fonte:"Instagram @atelie397, 30/07/2026"},
...
quem:"Alfredo Jaar",
txt:"Dia 8 de agosto a Luisa Strina abre duas individuais na mesma noite. Jaar traz 48 trabalhos dos anos 1970 e 1980, feitos sob a ditadura de Pinochet — um conjunto raramente visto no Brasil, mais perto do documento do que do objeto de galeria. Na sala ao lado, Anna Maria Maiolino apresenta Presença. No mesmo sábado, a Casa Triângulo abre Sem palavras, de Vânia Mignone. Vale reservar o dia inteiro para os Jardins.",
link:"https://www.galerialuisastrina.com.br/exhibitions",
publi:false
};

return { foco: FOCO, atualizado: "03/08/2026", venues: VENUES, expos: EXPOS, editais: EDITAIS, bairros: BAIRRO_COUNTS };
})();
